...
class Wallet(Node):
    ...
    def __init__(self, filename=None, password=None):  # noqa: E501
    ...
    @property
    def filename(self):
        """Gets the filename of this Wallet.  # noqa: E501

        The filename to store/load the wallet from. Note that this is relative to where turtle-wallet-api was launched from - it is recommended you use an absolute path.  # noqa: E501

        :return: The filename of this Wallet.  # noqa: E501
        :rtype: str
        """
    ...
    def filename(self, filename):
        """Sets the filename of this Wallet.

        The filename to store/load the wallet from. Note that this is relative to where turtle-wallet-api was launched from - it is recommended you use an absolute path.  # noqa: E501

        :param filename: The filename of this Wallet.  # noqa: E501
        :type: str
        """
    ...
    @property
    def password(self):
        """Gets the password of this Wallet.  # noqa: E501

        The password used to open the wallet  # noqa: E501

        :return: The password of this Wallet.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this Wallet.

        The password used to open the wallet  # noqa: E501

        :param password: The password of this Wallet.  # noqa: E501
        :type: str
        """
