...
class WalletSeedImport(WalletImport):
    ...
    def __init__(self, mnemonic_seed=None):  # noqa: E501
        """WalletSeedImport - a model defined in Swagger"""  # noqa: E501

        self._mnemonic_seed = None
        self.discriminator = None

        if mnemonic_seed is not None:
            self.mnemonic_seed = mnemonic_seed

    @property
    def mnemonic_seed(self):
        """Gets the mnemonic_seed of this WalletSeedImport.  # noqa: E501

        The 25 words mnemonic seed  # noqa: E501

        :return: The mnemonic_seed of this WalletSeedImport.  # noqa: E501
        :rtype: str
        """
        return self._mnemonic_seed

    @mnemonic_seed.setter
    def mnemonic_seed(self, mnemonic_seed):
        """Sets the mnemonic_seed of this WalletSeedImport.

        The 25 words mnemonic seed  # noqa: E501

        :param mnemonic_seed: The mnemonic_seed of this WalletSeedImport.  # noqa: E501
        :type: str
        """

        self._mnemonic_seed = mnemonic_seed
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WalletSeedImport, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WalletSeedImport):
            return False
