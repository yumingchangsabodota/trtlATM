...
class TransactionTransfers(object):
    ...
    def __init__(self, address=None, amount=None):  # noqa: E501
        """TransactionTransfers - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def address(self):
        """Gets the address of this TransactionTransfers.  # noqa: E501

        The receiving address of this transfer, or the sending address if the amount is negative  # noqa: E501

        :return: The address of this TransactionTransfers.  # noqa: E501
        :rtype: str
        """
    ...
    def address(self, address):
        """Sets the address of this TransactionTransfers.

        The receiving address of this transfer, or the sending address if the amount is negative  # noqa: E501

        :param address: The address of this TransactionTransfers.  # noqa: E501
        :type: str
        """
    ...
    @property
    def amount(self):
        """Gets the amount of this TransactionTransfers.  # noqa: E501

        The amount of this transfer, in atomic units  # noqa: E501

        :return: The amount of this TransactionTransfers.  # noqa: E501
        :rtype: float
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this TransactionTransfers.

        The amount of this transfer, in atomic units  # noqa: E501

        :param amount: The amount of this TransactionTransfers.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TransactionTransfers, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransactionTransfers):
            return False
