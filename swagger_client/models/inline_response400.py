...
class InlineResponse400(object):
    ...
    def error_code(self):
        ...
        A numeric code representing the error, for programmatic use. Error code mappings can be found here - https://github.com/turtlecoin/turtlecoin/blob/development/src/WalletBackend/WalletErrors.h We will endeavour to not change these mappings.  # noqa: E501
    ...
    def error_message(self):
        ...
        A human readable error message, for displaying to the user. It is suggested for programmers to not pattern match on these, and instead use the errorCode.  # noqa: E501
